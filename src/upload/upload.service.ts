    ...
    return new Promise((resolve, reject) => {
      const uploadStream = this.cloudinary.uploader.upload_stream(
        ...
        (error, result) => {
          ...
          console.log('Uploaded file URL:', result?.secure_url); // ✅ This is the correct place
          resolve(result?.secure_url as string);
          // console.log(resolve(result?.secure_url as string))
        },
      );
...
//     return new Promise((resolve, reject) => {
//       const uploadStream = this.cloudinary.uploader.upload_stream({ folder }, (err, result) => {
...
//   async uploadSingleFile(file: Express.Multer.File, folder = 'uploads'): Promise<string> {
//     return this.uploadToCloudinary(file, folder);
//   }

//   async uploadMultipleFiles(files: Express.Multer.File[], folder = 'uploads'): Promise<string[]> {
//     return Promise.all(files.map((file) => this.uploadToCloudinary(file, folder)));
//   }
// }
